(** IL type-based arbitrary value generator.
    ...
    Derives [Il.Value.t Gen.t] from [typ'] and [deftyp'] in [Lang.Il].
    Generates arbitrary values for types defined in a SpecTec spec,
    used as inputs for property-based testing. *)
...
(** [gen_of_deftyp spec outer_typ deftyp] handles [PlainT], [StructT], [VariantT].
